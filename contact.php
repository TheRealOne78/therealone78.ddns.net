    ...
    <div id="wrap">
      <div id="main">
        ...
        <div class="dw_cool">
          ...
          <p>This page lists my public contact methods.</p>
          <p>Please do not abuse (spam, pranks and things like that). Thank you.</p>
          <h4 id="e-mail">E-Mail</h4>
          <ul>
            <li>Primary: <a href="mailto:bajcsielias78@gmail.com" target="_blank">bajcsielias78@gmail.com</a></li>
            <li>Secondary: <a href="mailto:bajcsielias79@gmail.com" target="_blank">bajcsielias79@gmail.com</a></li>
          </ul>
          <h4 id="matrix">Matrix</h4>
          <ul>
            <li>@therealone78:matrix.org</li>
          </ul>
          <br>
          <h4 id="disclaimer">Disclaimer</h4>
          Page under construction. Don't expect any deadline...<br><br>
          <div align="center">
            <pre>
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⣀⡠⠤⠤⠀⠀⠀⠤⠤⠤⠤⣀⡀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⢀⡤⠒⠉⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠈⠙⠢⢄⡀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
